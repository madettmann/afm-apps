classdef DisplayApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            DisplayApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'Quickread')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong Quickread
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'Quickread').getString, ...
            ...
            if nargout(@Quickread) == 0
                eval('Quickread');
            else
                obj.AppHandle = eval('Quickread');
            end
